    ...
    <div class="bg-white rounded-lg shadow-md p-8">
        ...
        <form action="{{ route('pengajuan.storeDataForm') }}" method="POST" enctype="multipart/form-data" id="multiStepForm">
            ...
            <div id="page-1" class="form-page">
                <h3 class="text-xl font-bold text-gray-800 mb-6">Informasi Hak Cipta</h3>
                
                <!-- Judul Hak Cipta -->
                <div class="mb-4">
                    <label class="block text-gray-700 font-bold mb-2">Judul Hak Cipta *</label>
                ...
                <!-- Tempat Hak Cipta -->
                <div class="mb-4">
                    <label class="block text-gray-700 font-bold mb-2">Tempat Hak Cipta *</label>
                    <textarea name="tempat_hak_cipta" id="tempat_hak_cipta" required rows="5"
                        class="border border-gray-300 rounded w-full py-2 px-3 text-gray-700 focus:outline-none focus:ring-2 focus:ring-red-500"
                        placeholder="Jelaskan tempat hak cipta Anda"></textarea>
                </div>
                ...
                <!-- Tanggal Hak Cipta -->
                <div class="mb-6">
                    <label class="block text-gray-700 font-bold mb-2">Tanggal Hak Cipta *</label>
                    <input type="date" name="tanggal_hak_cipta" id="tanggal_hak_cipta" required
                        class="border border-gray-300 rounded w-full py-2 px-3 text-gray-700 focus:outline-none focus:ring-2 focus:ring-red-500"
                        max="{{ date('Y-m-d') }}">
                </div>
