...
<div class="max-w-4xl mx-auto py-8 px-4">
    <div class="bg-white rounded-lg shadow-md p-8">
        ...
        <div class="mb-6">
            ...
            <h2 class="text-2xl font-bold text-gray-800">Form Pengajuan Desain TLST</h2>
            <p class="text-gray-600 mt-2">Isi formulir di bawah ini untuk mengajukan desain TLST</p>
        </div>
        ...
        <form action="{{ route('pengajuan.storeDataForm') }}" method="POST" enctype="multipart/form-data" id="multiStepForm">
            @csrf
            <input type="hidden" name="jenis_ki" value="desain_tlst">

            <!-- PAGE 1: Data Form -->
            <div id="page-1" class="form-page">
                <h3 class="text-xl font-bold text-gray-800 mb-6">Informasi Desain TLST</h3>
                
                <!-- Judul Desain TLST -->
                <div class="mb-4">
                    <label class="block text-gray-700 font-bold mb-2">Judul Desain TLST *</label>
                    <input type="text" name="judul" id="judul" required
                        ...
                        placeholder="Masukkan judul desain TLST">
                </div>

                <!-- Tanggal Pertama di Entry -->
                <div class="mb-6">
                    <label class="block text-gray-700 font-bold mb-2">Tanggal Pertama di Entry *</label>
                    <input type="date" name="tanggal_pertama_entry" id="tanggal_pertama_entry" required
                        class="border border-gray-300 rounded w-full py-2 px-3 text-gray-700 focus:outline-none focus:ring-2 focus:ring-red-500"
                        max="{{ date('Y-m-d') }}">
                </div>

                <!-- Jumlah Lisensi DTLST -->
                <div class="mb-4">
                    <label class="block text-gray-700 font-bold mb-2">Jumlah Lisensi DTLST *</label>
                    <textarea name="jumlah_lisensi_dtlst" id="jumlah_lisensi_dtlst" required rows="5"
                        class="border border-gray-300 rounded w-full py-2 px-3 text-gray-700 focus:outline-none focus:ring-2 focus:ring-red-500"
                        placeholder="Jumlah lisensi desain TLST Anda"></textarea>
                </div>
                ...
                <!-- Tanggal Desain TLST -->
                <div class="mb-6">
                    <label class="block text-gray-700 font-bold mb-2">Tanggal Desain TLST *</label>
                    <input type="date" name="tanggal_desain_tlst" id="tanggal_desain_tlst" required
                        class="border border-gray-300 rounded w-full py-2 px-3 text-gray-700 focus:outline-none focus:ring-2 focus:ring-red-500"
                        max="{{ date('Y-m-d') }}">
                </div>
