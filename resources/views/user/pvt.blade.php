        ...
        <form action="{{ route('pengajuan.store') }}" method="POST" enctype="multipart/form-data" id="multiStepForm">
            ...
            <div id="page-1" class="form-page">
                ...
                <div class="mb-4">
                    ...
                    <input type="text" name="nama_umum" id="nama_umum" required
                        class="border border-gray-300 rounded w-full py-2 px-3 text-gray-700 focus:outline-none focus:ring-2 focus:ring-red-500"
                        placeholder="Masukkan nama umum PVT">
                </div>

                <!-- Nama Usulan PVT -->
                <div class="mb-4">
                    <label class="block text-gray-700 font-bold mb-2">Nama Usulan PVT *</label>
                    <input type="text" name="nama_usulan" id="nama_usulan" required
                        class="border border-gray-300 rounded w-full py-2 px-3 text-gray-700 focus:outline-none focus:ring-2 focus:ring-red-500"
                        placeholder="Masukkan nama usulan PVT">
                </div>

                <!-- Negara Asal PVT -->
                <div class="mb-4">
                    <label class="block text-gray-700 font-bold mb-2">Negara Asal PVT *</label>
                    <input type="text" name="negara_asal" id="negara_asal" required
                        class="border border-gray-300 rounded w-full py-2 px-3 text-gray-700 focus:outline-none focus:ring-2 focus:ring-red-500"
                        placeholder="Masukkan negara asal PVT">
                </div>

                <!-- Informasi Teknis -->
                <div class="mb-4">
                    <label class="block text-gray-700 font-bold mb-2">Informasi Teknis PVT *</label>
                    <input type="text" name="informasi_teknis" id="informasi_teknis" required
                        class="border border-gray-300 rounded w-full py-2 px-3 text-gray-700 focus:outline-none focus:ring-2 focus:ring-red-500"
                        placeholder="Masukkan informasi teknis PVT">
                </div>
                ...
                <div class="mb-4">
                    ...
                    <textarea name="deskripsi" id="deskripsi" required rows="5"
                        class="border border-gray-300 rounded w-full py-2 px-3 text-gray-700 focus:outline-none focus:ring-2 focus:ring-red-500"
                        placeholder="Jelaskan pvt Anda secara detail"></textarea>
                </div>
