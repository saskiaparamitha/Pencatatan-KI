...
@section('title', 'Form Pengajuan Desain Industri')
...
<div class="max-w-4xl mx-auto py-8 px-4">
    <div class="bg-white rounded-lg shadow-md p-8">
        ...
        <div class="mb-6">
            ...
            <h2 class="text-2xl font-bold text-gray-800">Form Pengajuan Desain Industri</h2>
            <p class="text-gray-600 mt-2">Isi formulir di bawah ini untuk mengajukan desain industri</p>
        </div>
        ...
        <form action="{{ route('pengajuan.storeDataForm') }}" method="POST" enctype="multipart/form-data" id="multiStepForm">
            @csrf
            <input type="hidden" name="jenis_ki" value="desain_industri">

            <!-- PAGE 1: Data Form -->
            <div id="page-1" class="form-page">
                <h3 class="text-xl font-bold text-gray-800 mb-6">Informasi Desain Industri</h3>
                
                <!-- Judul Desain Industri -->
                <div class="mb-4">
                    <label class="block text-gray-700 font-bold mb-2">Judul Desain Industri *</label>
                    <input type="text" name="judul" id="judul" required
                        ...
                        placeholder="Masukkan judul desain industri">
                </div>
                ...
                <div class="mb-4">
                    ...
                    <textarea name="deskripsi" id="deskripsi" required rows="5"
                        class="border border-gray-300 rounded w-full py-2 px-3 text-gray-700 focus:outline-none focus:ring-2 focus:ring-red-500"
                        placeholder="Jelaskan desain industri Anda"></textarea>
                </div>

                <!-- Tanggal Desain Industri -->
                <div class="mb-6">
                    <label class="block text-gray-700 font-bold mb-2">Tanggal Desain Industri *</label>
                    <input type="date" name="tanggal_desain_industri" id="tanggal_desain_industri" required
                        class="border border-gray-300 rounded w-full py-2 px-3 text-gray-700 focus:outline-none focus:ring-2 focus:ring-red-500"
                        max="{{ date('Y-m-d') }}">
                </div>
            ...
            <div id="page-2" class="form-page hidden">
                ...
                <p class="text-gray-600 mb-4">Tambahkan kolaborator yang terlibat dalam pembuatan desain industri ini (opsional)</p>
...
function validatePage(page) {
    if (page === 1) {
        // Validate page 1 fields untuk Desain Industri
        const judul = document.getElementById('judul').value.trim();
        const deskripsi = document.getElementById('deskripsi').value.trim();
        const tanggalDesainIndustri = document.getElementById('tanggal_desain_industri').value;
        
        if (!judul) {
            alert('Judul Desain Industri harus diisi');
        ...
        if (!tanggalDesainIndustri) {
            alert('Tanggal Desain Industri harus diisi');
            document.getElementById('tanggal_desain_industri').focus();
            return false;
        }
