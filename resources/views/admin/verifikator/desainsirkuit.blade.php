        ...
        <div class="flex-1 ml-64">
                ...
                <div class="flex items-center justify-between px-8 py-4">
                    ...
                    <div class="flex-1 max-w-md">
                        <div class="relative">
                            <input 
                                type="text" 
                                placeholder="Cari pengajuan desain sirkuit..." 
                                id="searchInput"
            ...
            <main class="p-8">
                <div class="space-y-6">
                    <!-- Page Header -->
                    <div>
                        <h1 class="text-3xl font-bold text-red-600 mb-2">Verifikasi Desain Sirkuit</h1>
                        <p class="text-gray-600">Kelola dan verifikasi pengajuan desain sirkuit, serta assign ke reviewer</p>
                    </div>
...
function verifikasiPengajuan(button, id) {
    ...
    Swal.fire({
        ...
        function openDetailModal(id) {
            ...
            fetch(`/verifikator/desain-sirkuit/${id}/detail`)
                .then(res => {
