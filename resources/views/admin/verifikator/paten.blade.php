...
<head>
    ...
    <title>Verifikasi Paten - Pencatatan KI</title>
        ...
        <aside class="w-64 bg-white shadow-xl fixed h-full z-50 overflow-y-auto">
            ...
            <nav class="p-4 space-y-1">
                ...
                <div id="dataKiMenu" class="ml-6 space-y-1 hidden">
                    <a href="{{ route('verifikator.paten') }}" class="sidebar-item active flex items-center gap-3 px-4 py-2 rounded-lg text-sm">
                    ...
                    <a href="{{ route('verifikator.hak-cipta') }}" class="sidebar-item flex items-center gap-3 px-4 py-2 rounded-lg text-sm">
                        <svg class="w-4 h-4 text-red-500" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    ...
                    <a href="{{ route('verifikator.merek') }}" class="sidebar-item flex items-center gap-3 px-4 py-2 rounded-lg text-sm">
                        <svg class="w-4 h-4 text-red-500" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    ...
                    <a href="{{ route('verifikator.desain-industri') }}" class="sidebar-item flex items-center gap-3 px-4 py-2 rounded-lg text-sm">
                        <svg class="w-4 h-4 text-red-500" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    ...
                    <a href="{{ route('verifikator.varietas-tanaman') }}" class="sidebar-item flex items-center gap-3 px-4 py-2 rounded-lg text-sm">
                        <svg class="w-4 h-4 text-red-500" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    ...
                    <a href="{{ route('verifikator.desain-sirkuit') }}" class="sidebar-item flex items-center gap-3 px-4 py-2 rounded-lg text-sm">
                        <svg class="w-4 h-4 text-red-500" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    ...
                    <a href="{{ route('verifikator.indikasi-geografis') }}" class="sidebar-item flex items-center gap-3 px-4 py-2 rounded-lg text-sm">
                        <svg class="w-4 h-4 text-red-500" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <div class="flex-1 ml-64">
            ...
            <main class="p-8">
                <div class="space-y-6">
                    <!-- Page Header -->
                    <div>
                        <h1 class="text-3xl font-bold text-red-600 mb-2">Verifikasi Paten</h1>
                        <p class="text-gray-600">Kelola dan verifikasi pengajuan paten, serta assign ke reviewer</p>
                    </div>
                            ...
                            <table class="w-full">
                                <thead class="bg-gradient-to-r from-red-600 to-pink-600 text-white">
                                    <tr>
                                        ...
                                        <th class="px-6 py-4 text-left text-sm font-semibold">Judul Paten</th>
    ...
    <div id="detailModal" class="modal">
        <div class="modal-content">
            ...
            <div class="flex items-center justify-between px-6 py-4 border-b border-gray-200 bg-gradient-to-r from-red-50 to-pink-50">
                <h2 class="text-2xl font-bold text-gray-800">Detail Pengajuan Paten</h2>
...
function verifikasiPengajuan(button, id) {
    ...
    Swal.fire({
        ...
        function openDetailModal(id) {
            ...
            fetch(`/verifikator/paten/${id}/detail`)
                .then(res => {
    ...
    <div class="flex justify-between items-center p-3 border rounded-lg">
        ...
        <a
            href="/verifikator/dokumen/${doc.trx_dokumen_ki_id}/download"
