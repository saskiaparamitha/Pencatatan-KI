        ...
        <aside class="w-64 bg-white shadow-xl fixed h-full z-50 overflow-y-auto">
            ...
            <nav class="p-4 space-y-1">
                ...
                <div id="dataKiMenu" class="ml-6 space-y-1 hidden">
                    ...
                    <a href="{{ route(Auth::user()->role . '.desain-sirkuit') }}" class="sidebar-item active flex items-center gap-3 px-4 py-2 rounded-lg text-sm">
                        <svg class="w-4 h-4 text-red-500" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <div class="flex-1 ml-64">
                ...
                <div class="flex items-center justify-between px-8 py-4">
                    ...
                    <div class="flex-1 max-w-md">
                        <div class="relative">
                            <input 
                                type="text" 
                                placeholder="Cari pengajuan indikasi geografis..." 
                                id="searchInput"
            ...
            <main class="p-8">
                <div class="space-y-6">
                    <!-- Page Header -->
                    <div>
                        <h1 class="text-3xl font-bold text-red-600 mb-2">Verifikasi Indikasi Geografis</h1>
                        <p class="text-gray-600">Kelola dan verifikasi pengajuan indikasi geografis, serta assign ke reviewer</p>
                    </div>
...
function verifikasiPengajuan(button, id) {
    ...
    Swal.fire({
        ...
        function openDetailModal(id) {
            ...
            fetch(`/verifikator/indikasigeografis/${id}/detail`)
                .then(res => {
