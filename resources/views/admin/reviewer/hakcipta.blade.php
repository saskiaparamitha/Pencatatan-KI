...
<head>
    ...
    <title>Review Hak Cipta - Pencatatan KI</title>
        ...
        <div class="flex-1 ml-64">
                ...
                <div class="flex items-center justify-between px-8 py-4">
                    ...
                    <div class="flex-1 max-w-md">
                        <div class="relative">
                            <input 
                                type="text" 
                                placeholder="Cari pengajuan hak cipta..." 
                                id="searchInput"
            ...
            <main class="p-8">
                <div class="space-y-6">
                    <!-- Page Header -->
                    <div>
                        <h1 class="text-3xl font-bold text-red-600 mb-2">Review Hak Cipta</h1>
                        <p class="text-gray-600">Lakukan review pengajuan hak cipta</p>
                    </div>
...
<div id="detail" class="tab-content active">
    ...
    <script>
        ...
        function openDetailModal(id) {
            ...
            fetch(`/reviewer/hak-cipta/${id}/detail`)
                .then(res => {
