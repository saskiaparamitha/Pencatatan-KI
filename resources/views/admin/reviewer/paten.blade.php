...
<head>
    ...
    <title>Review Paten - Pencatatan KI</title>
    ...
    <div class="flex min-h-screen">
        ...
        <aside class="w-64 bg-white shadow-xl fixed h-full z-50 overflow-y-auto">
            ...
            <div class="p-6 border-b border-gray-100">
                ...
                <p class="text-xs text-gray-500 mt-1">Reviewer Dashboard</p>
            </div>
            ...
            <nav class="p-4 space-y-1">
                ...
                <div id="dataKiMenu" class="ml-6 space-y-1 hidden">
                    <a href="{{ route(Auth::user()->role . '.paten') }}" class="sidebar-item active flex items-center gap-3 px-4 py-2 rounded-lg text-sm">
        ...
        <div class="flex-1 ml-64">
            ...
            <main class="p-8">
                <div class="space-y-6">
                    <!-- Page Header -->
                    <div>
                        <h1 class="text-3xl font-bold text-red-600 mb-2">Review Paten</h1>
                        <p class="text-gray-600">Lakukan review pengajuan paten</p>
                    </div>
...
@endif
    ...
    <td class="px-6 py-4">
        <div class="flex items-center justify-center gap-2">
            ...
            <button
            onclick="approvePengajuan({{ $item->trx_usulan_ki_id }})"
            ...
            <button
            onclick="rejectPengajuan({{ $item->trx_usulan_ki_id }})"
            ...
            <button
            onclick="commentPengajuan({{ $item->trx_usulan_ki_id }})"
...
<div id="detail" class="tab-content active">
    ...
    <script>
        ...
        function openDetailModal(id) {
            ...
            fetch(`/reviewer/paten/${id}/detail`)
                .then(res => {
    ...
    function commentPengajuan(id)
{
    ...
    .then(result=>{
        ...
        .then(res=>res.json())
        .then(res=>{
            Swal.fire('Komentar disimpan','','success')
        })
